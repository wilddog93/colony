                ...
                <div className='mb-10 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark'>
                    ...
                    <div className='p-4 md:p-6 xl:p-9'>
                        ...
                        <div className='mb-7.5 flex flex-wrap gap-5 xl:gap-7.5'>
                            ...
                            <Link
                                href='#'
                                className='inline-flex items-center justify-center gap-2.5 rounded-md bg-secondary py-4 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10'
                            >
                                <span>
                                    <svg
                                        className='fill-current'
                        ...
                        <div className='flex flex-wrap gap-5 xl:gap-7.5'>
                            ...
                            <Link
                                href='#'
                                className='inline-flex items-center justify-center gap-2.5 rounded-full bg-secondary py-4 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10'
                            >
                                <span>
                                    <svg
                                        className='fill-current'
                            ...
                            <Link
                                href='#'
                                className='inline-flex items-center justify-center gap-2.5 rounded-full bg-danger py-4 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10'
                            >
                                <span>
                                    <svg
                                        className='fill-current'
