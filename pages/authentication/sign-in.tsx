        ...
        <div className="relative overflow-hidden w-full h-screen lg:h-full flex items-center rounded-xl bg-white shadow-default p-10">
          <div
            className={`absolute bg-white left-0 top-0 z-50 flex w-full lg:w-1/2 h-full flex-col overflow-y-hidden duration-300 ease-in-out ${
              !loading ? "translate-x-0 visible" : "-translate-x-full invisible"
            }`}>
            <SignInComponent firebaseToken={firebaseToken} />
          </div>
          ...
          <div
            ...
            <div className={`absolute z-40 inset-y-1/2 right-0`}>
              <Tooltip
                className={`tooltip w-full text-sm bg-[#111F2C3D] p-2 rounded-lg focus:outline-none rounded-tr-none rounded-br-none`}
