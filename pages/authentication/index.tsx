        ...
        >
            <div className="w-full h-full p-10">
                ...
                <div className='relative w-full h-full flex flex-wrap items-center rounded-xl bg-white shadow-default'>
                    ...
                    <div className='hidden w-full h-full xl:block xl:w-1/2 transition-transform duration-500 border bg-primary text-white border-stroke rounded-xl'>
                        <div className='w-full h-full py-17.5 px-26 text-center'>
