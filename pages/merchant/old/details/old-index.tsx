      ...
      <div className="flex flex-col overflow-x-scroll h-screen bg-[#1C2D3D] min-h-full">
        ...
        <main className="h-screen pt-4">
          <div className="flex flex-col space-y-2 lg:flex-row">
            <div className="w-full lg:w-3/5 px-8 flex flex-col">
              {/* profile */}
              <MerchantCard />
              {/* merchant menu */}
              ...
              {/* search bar */}
              <div className="flex flex-col mt-4 overflow-x-auto no-scrollbar">
                <div className="w-full flex flex-row justify-center items-center">
                  <div className="lg:w-[90%] w-full flex justify-center items-center bg-white rounded-lg mr-2 p-2">
                    <input
                      type="text"
                      placeholder="search"
                      className=" bg-transparent w-full  focus:outline-none"></input>
                  </div>
            ...
            <div className="w-full lg:w-2/5 pb-2 px-8 lg:px-4 flex flex-col">
              <OverviewMenu />
            </div>
          </div>
        </main>
