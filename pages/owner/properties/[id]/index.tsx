                        ...
                        <div className='w-full relative tracking-wide text-left text-boxdark-2 mt-16 overflow-hidden'>
                            <div className="w-full h-full flex flex-1 flex-col overflow-auto gap-2.5 lg:gap-6 overflow-y-auto">
                                ...
                                <div className="w-full grid col-span-1 lg:grid-cols-3 gap-4 tracking-wider mb-5 px-8">
                                    <Cards
                                        className='w-full bg-white shadow-card text-gray-6 font-thin text-sm sm:text-base rounded-xl border border-gray'
                                    >
                                        <img
                                            src={property?.propertyLogo ? `${url}property/propertyLogo/${property?.propertyLogo}` : "../../image/no-image.jpeg"}
                                            alt=""
                                            className='bg-white rounded-t-lg w-full h-[250px] object-cover object-center'
                                        />
                                        <div className='w-full flex flex-col gap-4 p-4'>
                                            <h3 className='font-semibold text-lg lg:text-xl text-gray-5'>{property?.propertyName || "-"}</h3>
                                            ...
                                            <div className='flex items-center justify-between'>
                                                <div>
                                                    ...
                                                    <p className='font-semibold'>
                                                        {property?.totalUnitOccupant}/<span className='text-gray-5'>{property?.totalUnit}</span>
                                                    </p>
                                                </div>
                                                <div>
                                                    Tenants
                                            ...
                                            <div className='w-full flex flex-col gap-4 mb-4'>
                                                <h3 className='font-semibold text-lg lg:text-xl text-gray-5'>Contact info</h3>
                                                <div className='w-full flex gap-3'>
                                                    <div className='text-gray-5'><MdOutlinePhone className='w-6 h-6' /></div>
                                                    <p>{property?.phoneNumber ? formatPhone("+", property?.phoneNumber) : "-"}</p>
                                                </div>

                                                <div className='w-full flex gap-3'>
                                                    <div className='text-gray-5'><MdOutlineMailOutline className='w-6 h-6' /></div>
                                                    <p>{property?.email ? property?.email : "-"}</p>
                                                </div>

                                                <div className='w-full flex gap-3'>
                                                    <div className='text-gray-5'><MdOutlinePublic className='w-6 h-6' /></div>
                                                    <p>{property?.website ? property?.website : "-"}</p>
                                                </div>

                                                <div className='w-full flex gap-3'>
                                                    <div className='text-gray-5'><MdOutlinePlace className='w-6 h-6' /></div>
                                    ...
                                    <div className="w-full lg:col-span-2">
                                        <Cards className='w-full bg-white shadow-card text-gray-6 font-thin text-sm sm:text-base rounded-xl border border-gray p-4'>
                                            <div className='w-full grid col-span-1 lg:grid-cols-2 gap-2 items-center'>
                                                <h3 className='font-semibold text-title-md'>Revenue Growth (Million IDR)</h3>
                                                <div className='flex items-center gap-2 justify-end'>
                                                    <button
                                                        type='button'
                                                        className={`px-4 py-2 ${anualTabs == 'weekly' ? "font-semibold" : ''}`}
                                                    ...
                                                    <button
                                                        type='button'
                                                        className={`px-4 py-2 ${anualTabs == 'monthly' ? "font-semibold" : ''}`}
                                                    ...
                                                    <button
                                                        type='button'
                                                        className={`px-4 py-2 ${anualTabs == 'yearly' ? "font-semibold" : ''}`}
                                            ...
                                            <Barcharts data={bardataHour} options={barOptionsHour} height='250px' className='w-full max-w-max' />
                                        </Cards>
                                    </div>
                                </div>
                            </div>
