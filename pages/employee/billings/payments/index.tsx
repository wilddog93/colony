          ...
          return (
            <div className="w-full text-sm p-4 text-left border-b-2 border-gray">
              {member.length > 1
                ...
                : member?.length == 0
                ? `Division hasn't any member yet`
    ...
    <DefaultLayout
      ...
      <div className="absolute inset-0 mt-20 z-9 bg-boxdark flex text-white">
        ...
        <div className="relative w-full bg-white lg:rounded-tl-[3rem] p-8 pt-0 2xl:p-10 2xl:pt-0 overflow-y-auto">
          <div className="sticky bg-white top-0 z-50 mt-6 w-full flex flex-col gap-2">
            {/* headers */}
      ...
      <Modal size="small" onClose={onCloseDetail} isOpen={isOpenDetail}>
        <Fragment>
          ...
          quam, ab iusto aliquam cumque esse repellendus voluptas inventore iure
          in! Tempora repellendus consectetur nisi recusandae asperiores quo
          aspernatur esse nobis nulla ex dolorum, fugit illo incidunt tempore
          consequuntur qui numquam maiores accusantium possimus. Exercitationem
          adipisci tenetur dolores expedita culpa accusamus officia sit laborum
          possimus qui! Magni obcaecati exercitationem laboriosam nemo
          voluptates aspernatur adipisci, fuga dicta maxime ipsam animi repellat
          aliquam sit vero delectus perspiciatis labore pariatur, consectetur,
          temporibus nesciunt reprehenderit placeat. Voluptatem placeat laborum
          temporibus! Consectetur reiciendis exercitationem dolorum. Voluptates
          fugit repellat repellendus ullam fugiat repudiandae odio debitis
          tempore magnam.
        </Fragment>
      </Modal>
