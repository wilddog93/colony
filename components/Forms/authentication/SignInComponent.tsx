...
const SignInComponent = (props: Props) => {
  ...
  return (
    <div className="w-full h-full flex flex-col gap-1 text-gray-5 py-6">
      <Link className="flex items-center gap-2.5 px-6 xl:px-10" href="/">
        <img className="" src={"../image/logo/logo-icon.svg"} alt="Logo" />
        <h2 className="text-2xl text-graydark sm:text-title-xl2">Colony.</h2>
      </Link>

      <div className="flex flex-col gap-1 px-6 xl:px-10">
        <h2 className="font-bold text-xl text-graydark  sm:text-title-lg">
          Welcome Back
        </h2>
        <p className="text-gray-5 text-sm sm:text-title-sm">
      ...
      <form
        ...
        <div className="mb-3">
          ...
          <div className="relative">
            ...
            <MdOutlineEmail
              className={`absolute right-4 top-4 h-6 w-6 text-gray-5`}
            />
          </div>
          {emailError && (
            <div className="mt-1 text-danger text-sm lg:text-md">
              {emailError}
            </div>
          )}
        </div>
        ...
        <div className="mb-5 text-center lg:text-left">
          <Link
            ...
            className="w-full font-bold text-sm sm:text-title-sm mb-5 hover:text-graydark">
