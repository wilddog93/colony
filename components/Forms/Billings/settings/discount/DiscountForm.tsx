...
type FormValues = {
    id?: any,
    discountName?: string | any,
    dicountCode?: string | number | any,
    discountType?: any,
...
const DiscountForm = ({ items, isOpen, onClose }: Props) => {
                ...
                {errors?.discountName && (
                    <div className="mt-1 text-xs flex items-center text-red-300">
                        ...
                        <span className="text-red-300">
                            {errors?.discountName?.message as any}
                        </span>
                    </div>
                )}
            </div>
                ...
                <div className='w-full px-4'>
                    ...
                    <div className='relative'>
                        <input
                            ...
                            className='w-full rounded-xl border border-stroke bg-transparent py-3 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary'
                            {...register("dicountCode")}
                        />
                    </div>
                </div>

                <div className='w-full px-4'>
                    <label htmlFor='discountType' className='mb-2.5 block font-medium text-black dark:text-white'>
                        Type
                    </label>
                    <div className='relative'>
                        <Controller
                        ...
                        {errors?.discountType && (
                            <div className="mt-1 text-xs flex items-center text-red-300">
                                <MdWarning className="w-4 h-4 mr-1" />
                                <span className="text-red-300">
                                    {errors?.discountType?.message as any}
                                </span>
                            </div>
                        )}
                    </div>
