...
function TransactionTables(props: any) {
  const {
    divided,
    dataTable,
    columns,
    ...
    <div className="grid grid-cols-1">
      <div className="col-span-1 overflow-x-auto">
        <table className="w-full table-auto overflow-hidden rounded-xl shadow-md">
          ...
          <thead className="divide-y divide-gray-4 text-xs text-graydark bg-white tracking-wide">
          ...
          <tbody
            className={`divide-y divide-gray-4 bg-white text-graydark text-xs`}>
