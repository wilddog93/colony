      ...
      <div className="w-full mt-2 lg:mt-3">
        <div className="hidden md:flex flex-row justify-between items-center">
          <div className="flex items-center w-full border-b-2 text-white">
            <div
              className={
                router.pathname === "/merchant/detail"
                  ? "text-[#5F59F7] font-bold"
                  : "text-white"
              }>
              <Link
                href="/merchant/detail"
            ...
            <div
              className={
                router.pathname === "/merchant/category"
                  ? "text-[#5F59F7] font-bold"
                  : "text-white"
              }>
              <Link
            ...
            <div
              className={
                router.pathname === "/merchant/discounts"
                  ? "text-[#5F59F7] font-bold"
                  : "text-white"
              }>
              <Link
            ...
            <div
              className={
                router.pathname === "/merchant/hours"
                  ? "text-[#5F59F7] font-bold"
                  : "text-white"
              }>
              <Link
        ...
        <Transition
          ...
          {(ref) => (
            ...
            <div className="md:hidden id=mobile-menu">
              <div
                ref={ref}
                className="bg-white rounded-lg mt-2 pt-2 px-2 pb-3 space-y-1 sm:px-3">
                <Link
                  href="/items"
