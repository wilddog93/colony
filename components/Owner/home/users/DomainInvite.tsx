...
const DomainInviteForm = ({ items, isOpen, onClose, token, options, filters }: Props) => {
    ...
    return (
        <form className='w-full p-4 text-sm' onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className='w-full px-4 mb-3'>
                <label htmlFor='domainStructure' className='mb-2.5 block font-medium text-black dark:text-white'>
                    Roles
                </label>
                <div className='relative'>
                    <Controller
