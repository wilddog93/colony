...
// Auth me
export const getAccessProperty = createAsyncThunk<any, DefaultGetData, { state: RootState }>('auth/web/access/property', async (params, { getState }) => {
    ...
    try {
        const response = await axios.get("auth/web/access/property", config);
