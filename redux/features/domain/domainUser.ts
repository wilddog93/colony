...
// domain-users-all
export const getDomainUserAll = createAsyncThunk<
  any,
  DefaultGetData,
  { state: RootState }
>("domain-user-all", async (params, { getState }) => {
  ...
  try {
    const response = await axios.get("api/user/domain/all", config);
...
// domain-users-domain
export const getDomainUser = createAsyncThunk<
  any,
  DefaultGetData,
  { state: RootState }
>("domain-user", async (params, { getState }) => {
  let config: HeadersConfiguration = {
    params: params.params,
    headers: {
      "Content-Type": "application/json",
  ...
  try {
    const response = await axios.get("api/user/domain", config);
    const { data, status } = response;
...
// delete user arr
export const deleteDomainUsers = createAsyncThunk<
  any,
  UserDomainData,
  { state: RootState }
>("delete/domain-user", async (params, { getState }) => {
  let config: HeadersConfiguration = {
    headers: {
      "Content-Type": "application/json",
      Accept: "application/json",
  ...
  try {
    const response = await axios.delete("api/user/domain/remove", {
      data: params.data,
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
