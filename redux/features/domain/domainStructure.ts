...
export const getDomainStructures = createAsyncThunk<
  any,
  DefaultGetData,
  { state: RootState }
>("/domainStructure", async (params, { getState }) => {
  ...
  try {
    const response = await axios.get("api/domainStructure", config);
...
export const createDomainStructures = createAsyncThunk<
  any,
  DomainData,
  { state: RootState }
>("/post/domainStructure", async (params, { getState }) => {
  let config: HeadersConfiguration = {
    headers: {
      "Content-Type": "application/json",
      Accept: "application/json",
...
export const updateDomainStructures = createAsyncThunk<
  any,
  DomainData,
  { state: RootState }
>("/update/domainStructure", async (params, { getState }) => {
  let config: HeadersConfiguration = {
    headers: {
      "Content-Type": "application/json",
      Accept: "application/json",
...
export const deleteDomainStructures = createAsyncThunk<
  any,
  DomainData,
  { state: RootState }
>("/delete/domainStructures/", async (params, { getState }) => {
  let config: HeadersConfiguration = {
    headers: {
      "Content-Type": "application/json",
      Accept: "application/json",
  ...
  try {
    const response = await axios.delete(`domainStructure`, {
      data: params.data,
...
export const deleteDomainStructureById = createAsyncThunk<
  any,
  DomainData,
  { state: RootState }
>("/delete/domainStructures/id", async (params, { getState }) => {
  let config: HeadersConfiguration = {
    headers: {
      "Content-Type": "application/json",
      Accept: "application/json",
...
// get by id
export const getDomainStructureById = createAsyncThunk<
  any,
  DefaultGetData,
  { state: RootState }
>("/domainStructure/id", async (params, { getState }) => {
  let config: HeadersConfiguration = {
    params: params.params,
    headers: {
      "Content-Type": "application/json",
...
export const selectDomainStructures = (state: RootState) =>
  state.domainStructures;
